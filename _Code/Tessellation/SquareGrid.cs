...
namespace AhyangyiMaps.Tessellation
{
    public class SquareGrid : GridGenerator
    {
        ...
        public static void MakeSquareGalaxyNew(int outerPath, AspectRatio aspectRatioEnum, int galaxyShape, int symmetry, int dissonance, int numPlanets, ParameterService par)
        {
            ...
            // `overlap`
            int overlap = par.AddParameter(-1, 1, parts == 2? 1 : 0);
            ...
            {
                g.MakeY(aspectRatioEnum, unit, unit * branchWidth);
            }
        ...
        {
            {
                MakeSquareGalaxyNew(outerPath, aspectRatioEnum, galaxyShape, symmetry, dissonance, numPlanets, par);
                return (par.g, par.p);
            }
            ...
            else if (symmetry == 10100)
            {
                ...
                g = MakeGrid(rows, columns, borderWidth);
